<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        do{
            if(empty($prob_id) || empty($last_name) || empty($first_name) || empty($street) || empty($city) || empty($state_us) || empty($zip) || empty($phone_number) || empty($email) || empty($status)){
                    $errorMessage = "All the fields are required";
                    break; 
            }
            $sql = "INSERT INTO Prob_officer(Prob_ID, Last_name, First_name, Street, City, State_US, Zip, Phone_number, Email, Status)"."VALUES('$prob_id', '$last_name', '$first_name', '$street', '$city', '$state_us', '$zip', '$phone_number', '$email', '$status')";
